...
/**
 * Format a timestamp as relative time within the last day ("just now", "2 hours
 * ago"); anything a day or older shows the ACTUAL date + time (via
 * {@link formatTimestamp}) rather than a coarse "N days ago", so older changes
 * carry a precise, unambiguous timestamp.
 */
