          ...
          {compareMode ? (
            <>
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 bg-amber-500 text-amber-950 text-sm rounded-md hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed"
              >
